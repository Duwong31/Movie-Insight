...
@section('title', $title ?? 'Edit TV Show')

@section('content')
<div class="container">
    <h1>{{ $title ?? 'Edit TV Show' }}: {{ $tvshow->movie_name }}</h1>
    ...
    <form action="{{ route('admin.tvshows.update', $tvshow->movie_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-md-8">
                {{-- TV Show Name --}}
                <div class="mb-3">
                    <label for="movie_name" class="form-label">TV Show Name <span class="text-danger">*</span></label>
                    <input type="text" class="form-control @error('movie_name') is-invalid @enderror" id="movie_name" name="movie_name" value="{{ old('movie_name', $tvshow->movie_name) }}" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('movie_desc') is-invalid @enderror" id="movie_desc" name="movie_desc" rows="5">{{ old('movie_desc', $tvshow->movie_desc) }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('director') is-invalid @enderror" id="director" name="director" value="{{ old('director', $tvshow->director) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('release_date') is-invalid @enderror" id="release_date" name="release_date" value="{{ old('release_date', $tvshow->release_date) }}" min="1900" max="{{ date('Y') + 10 }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('duration') is-invalid @enderror" id="duration" name="duration" value="{{ old('duration', $tvshow->duration) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="url" class="form-control @error('trailer_url') is-invalid @enderror" id="trailer_url" name="trailer_url" value="{{ old('trailer_url', $tvshow->trailer_url) }}" placeholder="https://www.youtube.com/embed/your_video_id">
                                ...
                                <li>
                                    <div class="dropdown-item">
                                        <input class="form-check-input" type="checkbox" name="genres[]" id="genre_{{ $genre->genres_id }}" value="{{ $genre->genres_id }}"
                                               ...
                                               {{ (is_array(old('genres')) && in_array($genre->genres_id, old('genres'))) || (!old('genres') && isset($tvshowGenreIds) && in_array($genre->genres_id, $tvshowGenreIds)) ? 'checked' : '' }}
                                               >
            ...
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                        ...
                        <option value="in_theaters" {{ old('status', $tvshow->status) == 'in_theaters' ? 'selected' : '' }}>In Theaters</option>
                        <option value="streaming" {{ old('status', $tvshow->status) == 'streaming' ? 'selected' : '' }}>Streaming</option>
                        <option value="coming soon" {{ old('status', $tvshow->status) == 'coming soon' ? 'selected' : '' }}>Coming Soon</option>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="file" class="form-control @error('movie_image') is-invalid @enderror" id="movie_image" name="movie_image" onchange="previewImage(event)">
                     @if ($tvshow->movie_image)
                        <div class="mt-2">
                            <img id="image_preview" src="{{ asset('uploads/' . $tvshow->movie_image) }}" alt="Current Image" style="max-width: 100%; max-height: 200px; display: block;"/>
        ...
        <div class="mt-3">
            ...
            <a href="{{ route('admin.tvshows.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
@endsection
