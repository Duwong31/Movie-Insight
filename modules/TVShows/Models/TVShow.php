...
class TVShow extends Model
{
     ...
     */
    protected $casts = [
        'release_date' => 'integer', // Hoặc 'date' nếu bạn lưu kiểu date đầy đủ
        // 'actors_id' => 'array', // Nếu bạn lưu actors_id dạng JSON array trong CSDL
                                  // và muốn Eloquent tự động cast
    ];
    /**
