...
<div class="container-fluid">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.movies.index') }}" class="row g-3 align-items-center">
                <div class="col-md-10">
                    <input type="text" name="search" class="form-control" placeholder="Search by movie name..." value="{{ $search ?? '' }}">
                </div>
                <div class="col-md-2">
