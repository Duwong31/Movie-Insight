                    ...
                    <div class="rating-section">
                        ...
                        <div>
                            ...
                            <div class="rating-form" data-movie-id="{{ $movie->movie_id }}" data-current-rating="{{ ($userRating !== null && $userRating >=0) ? $userRating : 0 }}" style="display: none;">
                                ...
                                <button type="button" class="btn btn-remove-rating" data-movie-id="{{ $movie->movie_id }}" style="display: {{ ($userRating !== null && $userRating >=0) ? 'inline-block' : 'none' }}; color: #ff6347; margin-top: 10px;">
                                    Remove Rating
                                </button>
                            </div>
